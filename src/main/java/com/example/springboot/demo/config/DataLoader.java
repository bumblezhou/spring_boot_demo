...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        if(departmentRepository.count() == 0) {
            ...
            departmentRepository.save(new Department(null, "财务部", "3区11-1", "003", 10L, false));
            departmentRepository.save(new Department(null, "财务部", "4区11-1", "004", 15L, false));
            departmentRepository.save(new Department(null, "财务部", "5区11-1", "005", 18L, false));
            departmentRepository.save(new Department(null, "财务部", "6区11-1", "006", 22L, false));
            departmentRepository.save(new Department(null, "财务部", "7区11-1", "007", 37L, false));
            departmentRepository.save(new Department(null, "财务部", "8区11-1", "008", 41L, false));
            departmentRepository.save(new Department(null, "财务部", "9区11-1", "009", 29L, false));
            ...
            departmentRepository.save(new Department(null, "财务部", "11区1-1", "012", 56L, false));
            departmentRepository.save(new Department(null, "财务部", "12区1-1", "013", 67L, false));
            departmentRepository.save(new Department(null, "财务部", "13区1-1", "014", 43L, false));
            departmentRepository.save(new Department(null, "财务部", "14区1-1", "015", 18L, false));
            departmentRepository.save(new Department(null, "财务部", "15区1-1", "016", 123L, false));
            departmentRepository.save(new Department(null, "财务部", "16区1-1", "017", 321L, false));
            departmentRepository.save(new Department(null, "财务部", "17区1-1", "018", 1024L, false));
            departmentRepository.save(new Department(null, "行政部", "17区1-2", "019", 325L, true));
